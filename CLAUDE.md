...
User interacts:
  └→ ResponsesController#create      → auto-saves answers + difficulty rating +
       ...
       the end of the problem set and gates the Submit button — every answered
