...
not been submitted — whether that means untouched, half-answered, or answered
in full and never submitted. A save in the last hour holds it off, so someone
working through the set is not reminded to do what they are doing. It is off
unless asked for, and it changes nothing about enrolment.
