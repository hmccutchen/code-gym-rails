...
ActiveRecord::Schema[8.1].define(version: 2026_09_25_040303) do
  ...
  create_table "concept_masteries", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.string "drill_group"
    t.datetime "drilled_at"
  ...
  create_table "concept_references", force: :cascade do |t|
    ...
    t.index ["featured_on"], name: "index_concept_references_on_featured_on", unique: true
  end
  ...
  create_table "users", force: :cascade do |t|
    t.boolean "adaptive_set_size", default: true, null: false
    t.datetime "anonymized_at"
    t.text "api_key"
    t.datetime "created_at", null: false
    t.string "email", null: false
    t.jsonb "excluded_section_kinds", default: [], null: false
